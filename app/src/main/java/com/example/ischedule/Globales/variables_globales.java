...
public class variables_globales {
    ...
    public static final String CREAR_TABLA_TAREA = "CREATE TABLE "+tabla+" ("+campo_id+" INTEGER, " +
            ""+campo_titulo+" TEXT, "+campo_descripcion+" TEXT, "+campo_fecha+" TEXT, "+campo_hora+"" +
            " TEXT, "+campo_ubicacion+" TEXT, "+campo_url+" TEXT, "+campo_img+" TEXT)";
}
